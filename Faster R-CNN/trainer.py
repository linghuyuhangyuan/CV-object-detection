    ...
    * :obj:`total_loss`: The sum of 4 loss above.
    ...
    def forward(self, imgs, bboxes, labels, scale):
        ...
        * :math:`R` is the number of bounding boxes per image.
        ...
        sample_roi, gt_roi_loc, gt_roi_label = self.proposal_target_creator(roi, array_tool.tonumpy(bbox), array_tool.tonumpy(label), self.loc_normalize_mean, self.loc_normalize_std)
